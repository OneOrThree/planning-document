...
### 화면 미리보기
```text
Use case: ui-mockup. A crisp desktop UI reference for the Korean 'Catus' information architecture screen-preview workspace. Landscape1536x1024, quiet warm ivory #f7f6f0, oliveink#343c32, sage#e2e9da, clean Korean sans-serif14px and generous22pxlineheight,8pxradii, thindividers, no shadows/gradients/watercolor/nestedcards. Shippable functional tool, not marketing.
Header same flat72px band: left Korean rounded wordmark 'Catus' small '화면 설계', right links '마을로 돌아가기 ↗', '모바일 미리보기 ↗'. Underheader underline tabs '전체 구조' and active '화면 미리보기', right search '화면 이름·번호 검색'.
