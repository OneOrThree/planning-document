...
- 후속 건설 대상은 목표 선택 당시 주민으로 고정. 새 가입자 자동 추가 없음, 탈퇴/강퇴자는 제외. 공사 전 목표 변경 시 현재 주민으로 다시 설정하고 누적 획득은 유지한다.
- 후속 건설은 기존/이전 건물의 주민별 누적 획득을 인정한다. 전원 달성+잔액 충족 때 도장, 방장 공사 시작 시만 차감. 잔액이 줄면 도장은 해제·복구되고 누적 기록은 유지된다. 시작한 공사는 자기 차감 때문에 되돌리지 않는다.
...
|건설|초기 공동 고정 목표, 후속 주민별 누적 달성, 공동 잔액 조건과 공사.|4|
...
|05|새 섬 만들기|island-create|이름·소개·가입 방식·최대 15명|
...
|15|첫 마을회관 건설|construction, build, wallet|회관 100/1분, 게시판 추가200/3분; 방장 차감 실행|
|16|마을회관 공사 중|construction, build, wallet|회관 100/1분, 게시판 추가200/3분; 방장 차감 실행|
|17|회관 다음은 게시판|construction, build, wallet|회관 100/1분, 게시판 추가200/3분; 방장 차감 실행|
...
|43|마을회관 · 목각 건물 고르기|buildables, build-target|기능·대상·요구량·총 비용·공사 시간·잠금 이유|
|44|마을회관 · 건물 청사진|buildables, build-target|기능·대상·요구량·총 비용·공사 시간·잠금 이유|
...
|54|도서관 공사 중|construction, build|대상 달성+잔액 도장·방장 차감·완공 시 다음 목표|
...
후속 차감 비용은 대상 인원×1인당 요구량의 초기 정책값이다. 주민별 누적 달성과 실제 잔액을 별도 확인한다. 첫 회관/게시판은 공동 초기 목표이며 후속 주민별 목표로 계산하지 않는다. 게시판의 추가200 준비량 산정 범위는 서버 계약 시 문장으로 명확히 한다.
...
- 입력·조회: 이름·소개·approvalMode·maxResidents(최대 15)
...
- 입력·조회: 이름·소개·가입 방식·정원
- 반환·변경: 저장한 정보·주민 수·정원
- 권한: 방장
- 해금·조건: 회관; 초기 운영 진입은 미정
...
- 입력·조회: 발견/다음 후보 문맥
- 반환·변경: 가입 방식·정원·공개 섬 후보·내 신청 상태
- 권한: 게스트·회원
...
- 입력·조회: 초대 코드
- 반환·변경: 목적지 섬·가입 방식·정원·초대 유효 상태; 아직 가입 아님
- 권한: 게스트·회원
...
초기 공동 고정 목표, 후속 주민별 누적 달성, 공동 잔액 조건과 공사.
...
- 입력·조회: 섬 ID
- 반환·변경: 건물 기능·1인당 요구량·대상 수·총 비용·공사 시간·상태·잠금 이유
- 권한: 주민
...
- 반환·변경: 고정된 대상 주민·누적 달성·잔액 조건·연결 건설 퀘스트
- 권한: 방장
...
- 입력·조회: 섬 ID
- 반환·변경: 목표·준비량/대상 달성·잔액 조건·stampReady·공사/완공 시각
- 권한: 주민
...
|construction.updated|해당 섬 주민|목표·대상 달성·잔액 조건·도장·공사/완공|누적 유지; 잔액 부족으로 도장 해제·복구|
...
|P-EARNED-SCOPE|누적 획득 포함 범위|퀘스트 개인 보상·전원 보너스도 주민별 누적 획득과 건설 요구량에 포함하는가.|공동 잔액에는 적립. 구매·건설로 주민 누적은 감소하지 않는다.|
