...
- 모든 주민은 마지막 소속 섬에서도 탈퇴할 수 있고, 마지막 소속 섬에서 탈퇴하면 첫 소속 선택(03 혼자 시작 / 기존 섬 참여)으로 돌아간다. 주민이 남은 섬의 방장은 위임한 뒤 탈퇴하고, 주민이 방장 한 명뿐인 섬은 삭제 범위와 다음 도착지를 확인하면 섬을 삭제하고 나간다.
...
|P-LAST-KICK|마지막 섬 강퇴|소속된 마지막 섬에서 강퇴된 사용자의 처리.|메인 섬 하나 보유, 메인 섬 탈퇴·강퇴 시 가장 최근 가입한 남은 섬으로 변경·알림, 마지막 소속 섬도 탈퇴 가능·첫 섬 선택 화면으로 이동, 앱은 마지막 접속 섬에서 시작.|
