...
- 반환·변경: 일반 탈퇴는 소속 해제·다음 섬, 방장 1인 섬은 공동 데이터 삭제·남은 메인 섬 또는 첫 섬 선택 화면; 탈퇴한 섬이 메인 섬이면 가장 최근 가입한 남은 섬으로 변경·알림
...
|P-LAST-KICK|마지막 섬 강퇴|소속된 마지막 섬에서 강퇴된 사용자의 처리.|메인 섬 하나 보유, 메인 섬 탈퇴·강퇴 시 가장 최근 가입한 남은 섬으로 변경·알림, 앱은 마지막 접속 섬에서 시작.|
