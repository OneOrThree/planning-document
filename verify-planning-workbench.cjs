...
(async()=>{
 ...
 try{
  for(const width of [1440,1024,768,414,375,320]){
   ...
   check(gramophoneCost.includes('1인당 10마리')&&gramophoneCost.includes('5분'),'축음기 1인당 10마리·공사 5분');
   check(shopCost.includes('다른 모든 건물')&&shopCost.includes('1인당 50마리')&&shopCost.includes('1시간'),'상점은 마지막·1인당 50마리·공사 1시간');
