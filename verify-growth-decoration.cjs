...
(async()=>{
  ...
  check(feature('L16').decision==='chosen'&&feature('L16').title==='축음기 건설 퀘스트'&&feature('L16').note.includes('1인당 누적 획득 50마리')&&feature('L16').note.includes('5분')&&!feature('L16').note.includes('마을 포인트'),'축음기는 1인당 50마리·5분 건설 퀘스트');
  ...
  check(feature('F13').note.includes('완료 도장')&&feature('F13').note.includes('건설하기')&&feature('F13').note.includes('일일 초기화하지 않는다')&&feature('D22').note.includes('1분(60초)')&&feature('D22').note.includes('하루 최대 480마리'),'건물 건설 퀘스트·1분 1마리·하루 최대 480마리 기준');
