...
(async()=>{
  ...
  check(feature('L16').decision==='chosen'&&feature('L16').title==='축음기 건설 퀘스트'&&feature('L16').note.includes('1인당 누적 획득 10마리')&&feature('L16').note.includes('5분')&&!feature('L16').note.includes('마을 포인트'),'축음기는 1인당 10마리·5분 건설 퀘스트');
  ...
  check(feature('E14').note.includes('강아지 NPC 전용')&&feature('E14').note.includes('1인당 50마리'),'강아지 상점 NPC·마지막 상점 요구량');
  ...
  check(feature('F13').note.includes('완료 도장')&&feature('F13').note.includes('건설하기')&&feature('F13').note.includes('일일 초기화하지 않는다')&&feature('D22').note.includes('5분(300초)'),'건물 건설 퀘스트·5분 1마리 기준');
  check(feature('F03').note.includes('물고기 2마리')&&feature('L05').title==='일일 퀘스트 물고기 보상','일일 퀘스트 물고기 보상');
