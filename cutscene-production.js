...
(() => {
  ...
  window.CutsceneProduction={duration:24,targetReviews:30,directions,
    films:stories.flatMap((story,storyIndex)=>directions.map((direction,directionIndex)=>({
      ...
      tuning:{actorMode:'poses',paddleRig:true,paddleWeight:true,tailRig:true,walkRig:true,dockRig:true,raftContact:true,raftReflection:false,waterMotion:true,seabirds:true,oarTravel:true,clothFold:true,catSize:176,raftWidth:316,jumpHeight:36,landingBounce:5,shadowAlpha:.2,walkStride:15,
