...
const sources=['cutscenes.html','prologue-scenarios-data.js','cutscene-settings.js','cutscene-production.js','cutscene-renderer.js','cutscene-sprites.js','cutscene-poses.js','cutscene-paddle-rig.js','cutscene-walk-rig.js','cutscene-rig.js','cutscene-cinema.js','cutscene-review-log.js','cutscene-studio.js'];
async function main(){
