...
const tests = ['verify-feature-inventory.cjs','verify-planning-workbench.cjs','verify-journey-routes.cjs','verify-growth-decoration.cjs','verify-feature-story.cjs','scripts/smoke.cjs','scripts/verify-cutscenes.cjs','scripts/verify-cutscene-fur.cjs'];
(async () => {
