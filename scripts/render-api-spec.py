...
html='<!doctype html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#f8f6ed"><meta name="description" content="GROMO 2.0.0 화면별 API v1 백엔드 전달 협의안"><title>GROMO API v1 협의안</title><link rel="icon" href="data:,"><link rel="stylesheet" href="../../../feature-inventory.css"><link rel="stylesheet" href="../../../planning-tokens.css"><style>'+css+'</style></head><body><a class="skip" href="#api-content">API 본문으로 건너뛰기</a><div class="shell"><header class="api-header"><a class="brand" href="../../../">같이숲</a><span class="doc-kind">API 스펙</span><nav aria-label="관련 페이지"><a class="back-link" href="../../../feature-inventory.html?tab=growth">← 섬의 발전</a><a href="gromo-api-spec.md">Markdown 원문 ↗</a><a href="./" aria-current="page">API-스펙</a></nav></header><section class="api-intro" aria-labelledby="api-title"><div><p class="eyebrow">GROMO · API V1</p><h1 id="api-title">'+escape(TITLE)+'</h1><p class="api-intro-copy">2.0.0 화면에 필요한 조회와 행동을 화면·도메인·시설 기준으로 함께 확인하는 백엔드 전달 문서예요.</p></div><div class="api-state"><strong>협의안</strong><span>'+escape(VERSION)+'</span></div></section><details class="api-index"><summary>문서 목차 <span>'+str(len(nav))+'개 섹션</span></summary><nav class="api-index-nav" aria-label="API 문서 목차">'+''.join(f'<a class="{"sub" if level==3 else ""}" href="#{anchor}">{escape(title)}</a>' for anchor,title,level in nav)+'</nav></details></div><div class="toolbar"><div class="toolbar-inner shell"><label for="search">API 검색</label><input id="search" type="search" placeholder="기능·경로·권한 검색"><button id="clear" type="button">초기화</button><span id="count" aria-live="polite"></span></div></div><main id="api-content" class="api-content shell">'+''.join(html_parts)+'</main><footer class="api-footer shell"><p>기획 반영과 API 구현 완료는 별개예요.</p><a href="../../../feature-inventory.html?tab=growth">← 섬의 발전</a><a href="gromo-api-spec.md">Markdown 원문 ↗</a></footer><script>'+script+'</script></body></html>'
