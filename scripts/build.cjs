...
let excludedReviewImages=0,archivedVideos=0;
...
console.log(JSON.stringify({publishedBytes:bytes,excludedReviewImages,archivedVideos,reviewOriginals:'Git 저장소에 보존'}));
