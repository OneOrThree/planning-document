...
(() => {
  ...
  const entries = [
    ...
    {"id":"privacy-storage-baseline","status":"confirmed","title":"인증·사용량·분석 데이터의 저장 기준을 확정한다","body":"소셜 로그인에서는 제공자 고유 ID만 저장하고 이메일·이름은 저장하지 않는다. 시간 기반 보상의 단일 진실원으로 앱별 사용 시간을 서버에 저장한다. PostHog Session Replay를 사용하되 마스킹·보존기간·거부 수단을 구현 전에 확정한다. 데이터베이스 백업은 7일 보관한다.","link":"privacy-data-inventory-2026-09-21.md","date":"2026.09.21","source":"GROMO-1869 완료조건 1·3 · 사용자 결정"},
    ...
    {"id":"withdrawal-data-disposition","status":"confirmed","title":"탈퇴 데이터는 삭제·연결 해제·기간 보존으로 나눠 처리한다","body":"탈퇴 시 계정 이용 상태를 종료하고 직접 식별정보는 최대 7일 이내 삭제한다. 공동 콘텐츠는 작성자 연결을 끊어 유지하고, 법령상 보존자료·로그·백업·분석도구 데이터는 항목별 보존기간이 끝난 뒤 삭제한다. 7일은 모든 데이터의 최종 파기 기한이 아니다. 실제 삭제 배선과 Sentry·PostHog·첨부파일·백업의 보존기간이 검증되기 전에는 구현 완료로 표시하지 않는다.","link":"withdrawal-data-disposition-2026-09-21.md","date":"2026.09.21","source":"GROMO-1869 완료조건 3 · 사용자 결정"},
