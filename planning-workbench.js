...
(() => {
  ...
  const entries = [
    {"id":"policy-golden-fish","status":"confirmed","title":"같이 집중할수록 황금 물고기가 잘 나온다","body":"같이 집중해도 혼자일 때와 보상이 같던 문제를 황금 물고기로 푼다. 유효 집중 1분마다 낚는 물고기가 확률로 황금 물고기가 되고, 1마리는 물고기 50마리어치로 섬 잔액에 더한다. 확률은 낚는 순간 같은 섬에서 집중 중인 주민 수(나 포함·휴식 제외·최대 5명)로만 정하며 1분당 혼자 0.1%, 2명 0.2%, 3명 0.4%, 4명 0.6%, 5명 이상 0.8%다. 하루 480마리 상한에 닿으면 추첨도 멈추고, 황금 물고기로 늘어난 49마리는 상한과 별도로 준다. 낚는 순간 집중 화면의 1분 낚기 모션이 황금 물고기 모션으로 바뀌며 황금 여부는 서버가 정한다. 혼자 집중할 때의 기본 보상은 1분당 1마리 그대로다.","link":"feature-inventory.html?mode=detail#feature-D22","date":"2026.09.19","source":"GROMO-1921 · 사용자 결정"},
