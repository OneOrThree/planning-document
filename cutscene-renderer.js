...
(() => {
  ...
  function background(c,img,t){
    const z=1+S.cameraDrift*Math.sin(t*.14);c.drawImage(img,(W-W*z)/2,(H-H*z)/2,W*z,H*z);
  }
  ...
  window.CutsceneActors={ready,images,paths,background,ellipse,cat,book,raft,ripples,clamp,ease,mix};
})();
