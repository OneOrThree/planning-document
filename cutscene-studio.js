(() => {
  ...
  const section=document.getElementById('exports'),versions=['draft-v05','draft-v04','draft-v03','draft-v02','draft-v01'];let exportRequest=0;
