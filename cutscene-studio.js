(() => {
  ...
  const section=document.getElementById('exports'),versions=['draft-v03','draft-v02','draft-v01'];let exportRequest=0;
  ...
  async function loadExports(version){
    ...
    try{
      ...
      document.getElementById('export-note').textContent=({'draft-v03':'세 번째 초안 · 1080 × 1920. 책을 보는 자세·짧은 부두·승선 준비·그림책 전환·자막 개선을 포함해요. 출력 이후의 가방·밧줄 겹침 수정은 위 실시간 연출에 먼저 반영돼요.','draft-v02':'두 번째 초안 · 1080 × 1920. 이전 노 잡기·출항 경로를 비교할 수 있어요.','draft-v01':'첫 번째 초안 · 720 × 1280. 초기 상태 비교용으로 보존했어요.'})[version];
